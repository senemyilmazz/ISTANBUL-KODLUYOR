...
public class Main {
    public static void main(String[] args) {
        ...
        Car car = new Car(1, 2 , "BMW", 120000);
        Car car2 = new Car(2, 3, "Volkswagen", 2000000);
        Car car3 = new Car(3, 3, "Volkswagen", 2000000);
        Car car4 = new Car(4, 3, "Volkswagen", 2000000);
        Car car5 = new Car(5, 3, "Volkswagen", 2000000);
        Car car6 = new Car(6, 3, "Volkswagen", 2000000);
